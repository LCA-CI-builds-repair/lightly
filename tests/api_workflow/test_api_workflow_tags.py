...
def test_create_tag_from_filenames__file_not_found(mocker: MockerFixture) -> None:
    ...
    client = ApiWorkflowClient()
- Ensure that the assertion checking the exception message is properly aligned within the pytest context manager.
- Fix the typo in the error message "An error occured" to "An error occurred" for correctness.
- Check for missing parentheses at the end of the error message string.
