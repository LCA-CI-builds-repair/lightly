...
# - Add a newline character for better readability in the match string.
# - Ensure proper formatting and alignment of the AssertionError with the long match string.
