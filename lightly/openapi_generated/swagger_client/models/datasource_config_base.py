...
class DatasourceConfigBase(BaseModel):
    ...
    purpose: DatasourcePurpose = Field(..., description="Add description here")
    type: StrictStr = Field(..., description="Add description here")
    ...
    __properties__ = ["id", "purpose", "type", "thumbSuffix"]
    @validator('id')
